...
//require $CFG->dirroot.'/blocks/focusfad_courselist/vendor/autoload.php';
require $CFG->dirroot.'/blocks/custom_courselist/docs/documentation.php';
...
$docs = new block_custom_courselist_docs('README');
